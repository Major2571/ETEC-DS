...
<section>
    ...
    <div class="text-center w-3/4 m-auto mb-9">
        ...
        <div class="mb-3 max-w-md mx-auto bg-white rounded-xl shadow-md overflow-hidden md:max-w-2xl card">
            <div class="md:flex">
                ...
                <div class="p-8">
                    ...
                    <h4 class="uppercase tracking-wide text-indigo-500 font-semibold">
                        Contato & Sugestões
                    </h4>

                    <h6 class="mt-2 block mt-1 text-lg leading-tight font-medium text-black">
                        Quer melhorar a experiência no laboratório de informática ou está com problemas?
                    </h6>

                    <p class="mt-2 text-slate-500">
                        Nós podemos ajudar! Com o CamargoLabs, é fácil relatar problemas, enviar sugestões e se comunicar com nossa equipe de suporte técnico.
...
<section class="hello">
    ...
    <div class="title">
        ...
        <p class="block mt-1 leading-tight text-2xl text-gray-200 drop-shadow-lg">
